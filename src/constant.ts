...
export const BIRTHDAY_QUOTES_LIST: [string, string?][] = [
  [
    '星奏、お誕生日おめでとう。ずっと、ずっと愛しているよ。ずっと、ずっと追いかけているよ、永遠に。',
    '星奏，生日快乐哦。一直、一直深爱着你哦，一直、一直追寻着你哦，永远。'
  ],
  ['また一年が過ぎた。今日は君との距離が少しだけ近づいたかな？', '又一年过去了，今日是否与你的距离更近一点了呢？'],
  [
    '世界と星空、そして君——美しい風景。お誕生日おめでとう、星奏。',
    '世界、星空、与你——美丽的画面，生日快乐哦星奏。'
  ],
  [
    '追い求めて、望んで、待ち望んで——いつか必ず君と再会する。とにかく、お誕生日おめでとう。',
    '追寻着，希望着，期待着——终有一天与你重逢。总之，生日快乐。'
  ]
]
